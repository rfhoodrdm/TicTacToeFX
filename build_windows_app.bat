...
set IMAGE_TARGET_DIR=%OUTPUT_DIR%\image
...
jlink  --output %IMAGE_TARGET_DIR%  --module-path  %MODULES_TARGET_DIR%;%WINDOWS_JAVAFX_JMOD_PATH%  --add-modules  edu.usf.mail.rfhood.TicTacToeFX  --launcher TicTacToeFX=edu.usf.mail.rfhood.TicTacToeFX
